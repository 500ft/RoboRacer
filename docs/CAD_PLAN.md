...
is pending). PR #16 closed as superseded; its modal tap-test generator is not carried and stays
open under RR-S11. Disposition: `docs/CAD_REVIEW_DISPOSITION.md`.
